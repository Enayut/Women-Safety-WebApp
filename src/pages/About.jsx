    ...
    return (
        <div className="h-full w-full bg-secondary">
            <div className="container mx-auto p-6">
                <div className="max-w-4xl mx-auto w-3/4"> {/* Set max width and center */}
                    {/* About Us Section */}
                    <section className="about-us mb-12 bg-background p-6 rounded-lg shadow-md">
                    ...
                    {/* Contact Us Section */}
                    <section className="contact-us mb-12 bg-background p-6 rounded-lg shadow-md">
